	...
	<nav class="fixed w-full z-20">
		<div style="max-width:1536px" class="grid grid-cols-2 lg:grid-cols-9 px-2 lg:p-6 py-3 lg:py-3 mx-auto w-full">
			...
			<transition name="selectorSlide">
				<div v-if="navOpen || windowWidth > 1024" id="navLinkRow" class="col-span-5 absolute lg:relative bg-kindaWhite lg:bg-transparent w-full lg:w-auto right-0 top-s lg:top-0 flex flex-col lg:flex-row gap-y-2 lg:gap-0 py-2 lg:py-0 justify-evenly items-center text-2xl lg:text-xl">
